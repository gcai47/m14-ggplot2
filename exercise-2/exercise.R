...
ggplot(data = sample_n(diamonds, 1000)) + geom_point(mapping = aes(x = cut, y = clarity), position = "jitter")
...
ggplot(data = sample_n(diamonds, 1000)) + geom_point(mapping = aes(x = carat, y = price, color = clarity))

# Change the color of the previous plot using a ColorBrewer scale of your choice. What looks nice?
ggplot(data = sample_n(diamonds, 1000)) + geom_point(mapping = aes(x = carat, y = price, color = clarity)) + scale_color_brewer(palette = "RdPu")
